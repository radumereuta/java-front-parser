...
public class JavaFrontParserParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("JavaFrontParser");
  ...
  { 
    JavaFrontParserParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = JavaFrontParserParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = JavaFrontParserParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(JavaFrontParserParseControllerGenerated.class);
    }
  ...
  { 
    return JavaFrontParserParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
